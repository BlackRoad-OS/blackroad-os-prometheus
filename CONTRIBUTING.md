# Contributing to blackroad-os-prometheus
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-os-prometheus.git
cd blackroad-os-prometheus

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-os-prometheus.git
